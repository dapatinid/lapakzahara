...
function simpan_et_fs() {
    ...
    if (id_produk_new_fs == '') {
        ...
        data_edit_timefs.append("time_fs_ub", id_produk_new_fs);
        ...
        xhttp.open("POST", "../../system/admin/freeshipping/edit-time.php", true);
...
function simpan_tp_fs() {
    ...
    if (id_produk_new_fs.value) {
        ...
        xhttp.open("POST", "../../system/admin/freeshipping/add-product.php", true);
...
function hapus_produk_ya() {
    ...
    xhttp.open("POST", "../../system/admin/freeshipping/delete-product.php", true);
...
function simpan_edp_fs() {
    ...
    xhttp.open("POST", "../../system/admin/freeshipping/edit-product.php", true);
