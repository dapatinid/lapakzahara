...
function show_edit_akun(id_user_ed, nama_lengkap_ed, verifikasi_user_ed, email_ed, no_wa_ed, tipe_akun_ed, saldo_ed) {
    nama_lengkap_edt.value = nama_lengkap_ed;
    verifikasi_user_edt.value = verifikasi_user_ed;
    email_edt.value = email_ed;
    no_wa_edt.value = no_wa_ed;
    tipe_akun_edt.value = tipe_akun_ed;
    saldo_edt.value = saldo_ed;  // Menambahkan ini untuk memasukkan saldo ke form
...
function simpan_edit_iklan() {
    ...
    data_edit_akun.append('verifikasi_user_edt', document.getElementById('verifikasi_user_edt').value);
    ...
    data_edit_akun.append('saldo_edt', document.getElementById('saldo_edt').value); // Menambahkan saldo
