...
<html lang="en">
   <head>
      ...
      <title>Chatting | <?php echo $title_name; ?></title>
      <!-- META SEO -->
      ...
      <div class="chat">
         <div class="box_chat">
            <div class="list_chat" id="list_chat">
               ...
               <a href="javascript:history.back(-1)" class="logo_chat" style="width:25px;position:absolute;right:30px;top:33px;opacity:30%;"><img src="../assets/icons/back.svg"></a>
