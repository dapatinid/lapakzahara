...
<html lang="en">
   <head>
      ...
      <title>Jual Produk Gratis Ongkir & Terlengkap | <?php echo $title_name; ?></title>
      <!-- META SEO -->
   ...
   WHERE `tipe_iklan`='' AND `status`='' AND `gratis_ongkir`='ya' AND `status_moderasi`='Diterima'
   ORDER BY `waktu` DESC 
   LIMIT $offset, $productsPerPage");
               ...
               $after_dot_rat = substr($data_rata_rating_vp['rata_rat'], 2, 1);
                      ...
                      if ($produk_terlaris_data['stok'] !== $produk_terlaris_data['terjual'] or $produk_terlaris_data['stok'] > $produk_terlaris_data['terjual']) {
                  ?>
            <!-- SHARE PRODUK -->
