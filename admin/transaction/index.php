...
<div class="back_up_ri" id="back_up_ri">
    <div class="up_ri">
        ...
        <div class="box_delman">
            ...
            ?>
                <div class="isi_box_delman" data-id="<?php echo $data_s_kpto['id']; ?>" data-nama="<?php echo $data_s_kpto['nama']; ?>" onclick="pilih_delman(this, '<?php echo $jum_kpto; ?>')"><?php echo $data_s_kpto['nama_asli']; ?></div>
            <?php
            }
            ?>
        </div>
...
<!-- UPLOAD RESI -->
    ...
    <div class="isi_list_transaksi_admin" id="sudah_bayar">
        <p>Sudah Dibayar</p>
        <?php if (isset($jumlahTipeProgress['Dikemas']) && $jumlahTipeProgress['Dikemas'] !== 0) : ?>
            <div class="icowls1">
                <h4><?php echo $jumlahTipeProgress['Dikemas']; ?></h4>
            </div>
        <?php endif; ?>
    </div>
    <div class="isi_list_transaksi_admin" id="dalam_perjalanan">
        <p>Dikirim</p>
        <?php if (isset($jumlahTipeProgress['Dikirim']) && $jumlahTipeProgress['Dikirim'] !== 0) : ?>
            <div class="icowls1">
                <h4><?php echo $jumlahTipeProgress['Dikirim']; ?></h4>
            </div>
        <?php endif; ?>
    </div>
    <div class="isi_list_transaksi_admin" id="selesai">
        <p>Selesai</p>
        <?php if (isset($jumlahTipeProgress['Selesai']) && $jumlahTipeProgress['Selesai'] !== 0) : ?>
            <div class="icowls1">
                <h4><?php echo $jumlahTipeProgress['Selesai']; ?></h4>
            </div>
        <?php endif; ?>
    </div>
    <div class="isi_list_transaksi_admin" id="dibatalkan">
        <p>Dibatalkan</p>
        <?php if (isset($jumlahTipeProgress['Dibatalkan']) && $jumlahTipeProgress['Dibatalkan'] !== 0) : ?>
            <div class="icowls1">
                <h4><?php echo $jumlahTipeProgress['Dibatalkan']; ?></h4>
            </div>
        <?php endif; ?>
    </div> 
</div>
