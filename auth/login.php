...
if (isset($_GET['code'])) {
    ...
    if (!isset($token['error'])) {
        ...
        // Mengambil nama pengguna dari alamat email (menghilangkan domain dan karakter yang tidak diinginkan)
        $nama_lengkap_google = $data['given_name'] . ' ' . $data['family_name'];
...
<html lang="en">
   ...
   <div class="form_log_reg">
      <p id="p_email"></p>
      <input type="text" placeholder="Username atau Email" class="input" id="email">
   </div>
   <div class="form_log_reg">
      <p id="p_password"></p>
      <input type="password" placeholder="Password" class="input" id="password">
            ...
            <div style="margin-top: 15px;">
                <a href="<?php echo $url; ?>/lost-password" class="lupa_passp" style="color: var(--semi-black); font-weight: 500; font-size: 14px;">Lupa Password?</a>
            </div>
            <div id="masuk_button">
