...
$update_dibaca_chat = $server->query("UPDATE `chat` SET `status`='dibaca' WHERE `pengirim_user_id`='$v_id_chat' AND `penerima_user_id`='$iduser' ");

$select_chat_view = $server->query("SELECT * FROM `chat` WHERE `pengirim_user_id`='$iduser' AND `penerima_user_id`='$v_id_chat' OR `pengirim_user_id`='$v_id_chat' AND `penerima_user_id`='$iduser' ORDER BY `chat`.`id` ASC ");
