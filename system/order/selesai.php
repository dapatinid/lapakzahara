...
$result = $server->query("SELECT * FROM `invoice`, `iklan`, `kategori` WHERE invoice.id_user='$iduser' AND invoice.tipe_progress='Selesai' AND invoice.id_iklan=iklan.id AND iklan.id_kategori=kategori.id ORDER BY `invoice`.`idinvoice` DESC ");
$total = mysqli_num_rows($result);

$select_invoice = $server->query("SELECT * FROM `invoice`, `iklan`, `kategori` WHERE invoice.id_user='$iduser' AND invoice.tipe_progress='Selesai' AND invoice.id_iklan=iklan.id AND iklan.id_kategori=kategori.id ORDER BY `invoice`.`idinvoice` DESC LIMIT $mulai, $halaman ");
        ...
        ?>
            <div class="isi_cart" id="isi_cart<?php echo $invoice_data['id']; ?>">
                ...
                <div class="box_detail_isi_cart">
                    ...
                    if ($data_rating_iv) {
                    ?>
                        <div class="bayar dspn">Nilai</div>
                        <p class="snilai dspb">Selesai</p>
                    <?php
                    } else {
                    ?>
                        <div class="bayar dspb" id="bu_snilai<?php echo $invoice_data['idinvoice']; ?>" onclick="show_bp('<?php echo $invoice_data['idinvoice']; ?>')">Nilai</div>
                        <p class="snilai dspn" id="snilai<?php echo $invoice_data['idinvoice']; ?>">Selesai</p>
                    <?php
                    }
                    ?>
                </div>
