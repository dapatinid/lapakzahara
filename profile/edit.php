...
<html lang="en">
   <head>
      <title>Edit Profil <?php echo $profile['nama_lengkap']; ?> | <?php echo $title_name; ?></title>
      <!-- META SEO -->
   ...
   <body>
      ...
      <div class="edit_profile">
         ...
         <div class="box_input_pro">
            ...
            <div class="isi_box_input_pro">
               <p id="p_email">Alamat Email</p>
               <input type="text" class="input" id="email" placeholder="email" value="<?php echo $profile['email']; ?>">
            </div>
            <div class="isi_box_input_pro">
